...
- [PC3_PC2_INTEGRATION.md](/home/osj/smart-mirror-aiot-coaching/PC3_PC2_INTEGRATION.md)
  PC3 담당자 전달용 단일 명세
- [pc2_GUIDE.md](/home/osj/smart-mirror-aiot-coaching/pc2_GUIDE.md)
  운영/구조/환경변수 가이드

`prompt/` 아래 문서는 발표/정리용 보조 문서이며, 연동 계약의 기준본으로 사용하지 않습니다.
